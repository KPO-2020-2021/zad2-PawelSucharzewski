...
${TBIN}/test_9: ${TBIN} ${OBJ}/LZespolona.o 
	g++ -o ${TESTS}/bin/test_9 ${FLAGS} -I${TESTS}/doctest ${TESTS}/test9.cpp ${OBJ}/LZespolona.o ${OBJ}/WyrazenieZesp.o ${OBJ}/Statystyki.o

${TBIN}:
	mkdir ${TBIN}

test:  ${TBIN}/test_1 ${TBIN}/test_2 ${TBIN}/test_3 ${TBIN}/test_4 ${TBIN}/test_5 ${TBIN}/test_6 ${TBIN}/test_7 ${TBIN}/test_8 ${TBIN}/test_9
	${TBIN}/test_1 
	${TBIN}/test_2
	${TBIN}/test_3 
	${TBIN}/test_4 
